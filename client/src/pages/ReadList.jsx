...
const CompletedList = () => {
  ...
  const FetchList = async () => {
    const result = await axios.get(`/mostreadall?page=${page}`);
    return result.data.data;
  };

  const { data: list, isLoading } = useQuery(["lists", page], ()=> FetchList(page));
  ...
  return (
    <>
    <Helmet>
        <title>Manga Swipe - Most Read Manga</title>
    ...
    <div className="text-center">
      <h1 className="text-5xl my-[25px]">Most Read Manga</h1>
