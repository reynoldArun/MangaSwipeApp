...
const ComingSoonList = () => {
  ...
  const FetchComingSoonList = async () => {
    const result = await axios.get(`/comingsoon?page=${page}`);
    return result.data.data;
  };

  const { data: list, isLoading } = useQuery(["lists", page], () => FetchComingSoonList(page));
